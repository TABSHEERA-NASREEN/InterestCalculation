...
public class BankService {
	...
	public void calculate(float principal,int tenure, int age, String gender)
	{
		...
		if(validateFlag)
		{
			...
			System.out.println("Total amount "+totalPrincipalDeposited);
			System.out.println("Total Maturity amount"+rda.calculateMaturityAmount(totalPrincipalDeposited,maturityInterest));
		}
	}
}
